...
<html>
	...
	v1/owners?include=employees:per_page(15):current_page(1)
        ...
        <br>
        <li> GET owners?include=employees, cashiers, outlets, products, taxes, <b>categories</b> </li> 
        <li> GET owners/{id}?include=employees ,cashiers,outlets, products, taxes, categories, categories.products </li>
        <li> POST owners </li>
        <li> PUT owners/{id} </li>
